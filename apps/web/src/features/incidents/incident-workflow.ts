export type IncidentWorkflowStatus='NEW'|'ACKNOWLEDGED'|'IN_PROGRESS'|'MONITORING'|'RESOLVED'|'CLOSED'|'CANCELLED'
...
const requiredWorkflowFields:Partial<Record<IncidentWorkflowStatus,string[]>>={
  ...
  CLOSED:['assignedToId','initialAssessment','containmentAction','resolution','rootCause','correctiveAction','preventiveAction','lessonsLearned'],
}
