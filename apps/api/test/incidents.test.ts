...
import { assertIncidentTransition,incidentMissingFields,incidentPriority,incidentSla,incidentStatusRequiresAssignee,isEligibleIncidentOperator } from '../src/modules/incidents/incidents.rules'
...
test('incident resolution and closure require evidence in workflow order',()=>{
  ...
  assert.deepEqual(incidentMissingFields('CLOSED',{...resolved,preventiveAction:'Kiểm tra định kỳ',lessonsLearned:'Theo dõi cảnh báo'}),[])
})
