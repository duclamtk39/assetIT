...
export class CategoriesController{
  ...
  @Delete(':id') remove(@Param('id',ParseUUIDPipe) id:string,@Req() req:AuthRequest){this.categories.assertAdmin(req.authUser);return this.categories.remove(id,req.authUser)}
}
